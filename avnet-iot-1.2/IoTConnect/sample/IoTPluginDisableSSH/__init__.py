...
# SDK call backs
def callbackMessageDisableSSH(msg):
...
def callbackTwinMessageDisableSSH(msg):
    if msg:
...
def __init__(self,myglobals):
    ...
    OnBoard.RegisterCallbackMsg(callbackMessageDisableSSH)
    OnBoard.RegisterCallbackTwinMsg(callbackTwinMessageDisableSSH)
