import os
global SetDigitalOutput1Now
global DigitalOutSet1Port

# SDK call backs
def callbackMessageDigitalOutSet1(msg):
...
def callbackTwinMessageDigitalOutSet1(msg):
    if msg:
...
def __init__(self,myglobals):
    ...
    OnBoard.RegisterCallbackMsg(callbackMessageDigitalOutSet1)
    OnBoard.RegisterCallbackTwinMsg(callbackTwinMessageDigitalOutSet1)
    DigitalOutSet1Port = int(my_config_parser_dict["IoTPluginDigitalOutputSet1Command1"]["usegpiooutput"])
    if (DigitalOutSet1Port == 1):        
        ...
        print("Invalid port selected " + str(my_config_parser_dict["IoTPluginDigitalOutputSet1Command1"]["usegpiooutput"]))
