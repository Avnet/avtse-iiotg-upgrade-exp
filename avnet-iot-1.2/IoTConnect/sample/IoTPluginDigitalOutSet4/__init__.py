import os
global SetDigitalOutput4Now
global DigitalOutSet4Port

# SDK call backs
def callbackMessageDigitalOutSet4(msg):
...
def callbackTwinMessageDigitalOutSet4(msg):
    if msg:
...
def __init__(self,myglobals):
    ...
    OnBoard.RegisterCallbackMsg(callbackMessageDigitalOutSet4)
    OnBoard.RegisterCallbackTwinMsg(callbackTwinMessageDigitalOutSet4)
    DigitalOutSet4Port = int(my_config_parser_dict["IoTPluginDigitalOutputSet4Command1"]["usegpiooutput"])
    if (DigitalOutSet4Port == 1):        
        ...
        print("Invalid port selected " + str(my_config_parser_dict["IoTPluginDigitalOutputSet4Command1"]["usegpiooutput"]))
