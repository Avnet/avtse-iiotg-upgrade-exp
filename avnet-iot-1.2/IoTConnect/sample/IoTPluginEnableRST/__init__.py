...
# SDK call backs
def callbackMessageEnableRST(msg):
...
def callbackTwinMessageEnableRST(msg):
    if msg:
...
def __init__(self,myglobals):
    ...
    OnBoard.RegisterCallbackMsg(callbackMessageEnableRST)
    OnBoard.RegisterCallbackTwinMsg(callbackTwinMessageEnableRST)
